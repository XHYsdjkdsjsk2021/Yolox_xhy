...
def image_demo(predictor, vis_folder, path, current_time, save_result):
    ...
    for image_name in files:
        im0 ,outputs, img_info = predictor.inference(image_name)
        ...
        if outputs[0] is None:
            ...
            # print('dangerous!!',base)
            # cv2.imwrite('/data/haoyuan/yolox_add/x_'+str(num)+'.jpg',im0)
...
if __name__ == "__main__":
    ...
    result = mean_average_precision(pred_bboxes, true_boxes,iou_threshold=0.5)
    print("mAP@50 =",result)
    sum_result = []
    for numer in range(10):
        result = mean_average_precision(pred_bboxes, true_boxes,iou_threshold=(0.5+numer*0.05))
        sum_result.append(result)
    result_95 = sum(sum_result)/len(sum_result)
    print("mAP@50_95=",result_95)
